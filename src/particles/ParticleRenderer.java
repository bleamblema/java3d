...
public class ParticleRenderer {
	...
	private static final int INSTANCE_DATA_LENGTH = 21; //4+4(offsetx1+offsetx2+offsety1+offsety2)+1(float blend)
	...
	protected void updateTexCoordInfo(Particle particle, float[] data){
