...
public class Loader {
	...
	public int loadTexture(String fileName) { 
		...
		if(GLContext.getCapabilities().GL_EXT_texture_filter_anisotropic){
			System.out.println("Anisotropic Filtering supported");
	...
	public int loadTextureAltlas(String fileName) { 
		int textureID = -1;
		try {
		InputStream in = new FileInputStream("res/" + fileName + ".png");
		PNGDecoder decoder = new PNGDecoder(in); 
	...
	private TextureData decodeTextureFile(String fileName){
		...
		try {
			...
			e.printStackTrace();
			System.err.println("Tried to load texture "+ fileName + ", dont work");
			System.exit(-1);
		}
